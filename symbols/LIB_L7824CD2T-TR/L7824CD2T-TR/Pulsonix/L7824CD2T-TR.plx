...
(library Library_1
	...
	(patternDef "ST_D2PAK" (originalName "ST_D2PAK")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0.356, -2.527) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 18)
		...
		(layerContents (layerNumRef 28)
			(line (pt -5.1375 0) (pt 5.1375 0) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 5.1375 0) (pt 5.1375 -9) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 5.1375 -9) (pt -5.1375 -9) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -5.1375 -9) (pt -5.1375 0) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "L7824CD2T-TR" (originalName "L7824CD2T-TR") (compHeader (numPins 3) (numParts 1) (refDesPrefix IC)
		...
		(attr "<STEP Filename>" "L7824CD2T-TR.stp")
		(attr "<STEP Offsets>" "X=0;Y=-4.98;Z=2.2")
